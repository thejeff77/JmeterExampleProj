...
1. Configure jmeter for command line launch by adding Jmeter's /bin bath to your PATH in either Windows or Linux. Linux is typically done via .profile or .bashrc.
